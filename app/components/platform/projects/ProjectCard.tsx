    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        <div className="flex items-center justify-center mb-3 mt-2">
          <div className="flex items-center justify-center w-16 h-16 bg-gradient-to-br from-[#e86b47] to-[#d45a36] rounded-2xl group-hover:scale-110 transition-all duration-300 shadow-lg overflow-hidden">
            <img 
        ...
        <h3 className="text-center text-base font-semibold text-text-primary dark:text-white group-hover:text-[#e86b47] transition-colors line-clamp-2 mb-4 leading-tight px-2">
          {project.name}
        </h3>
        ...
        <div className="space-y-2">
          {/* Template badge - Small badge if exists - always visible */}
          {project.templateName && (
            <div className="flex justify-center">
              <div className="inline-flex items-center gap-1 px-2 py-1 bg-[#e86b47]/90 dark:bg-[#e86b47]/80 backdrop-blur-sm border border-[#e86b47]/30 rounded-md shadow-sm">
          ...
          <div className="flex items-center justify-center">
            <div className="text-xs text-text-tertiary dark:text-white/60 font-medium">
