...
export function FloatingUser() {
  ...
  return (
    <div className="fixed top-20 left-6 z-50 flex flex-col gap-3">
      ...
      <Link
        to="/settings"
        className="flex items-center justify-center w-10 h-10 rounded-full bg-[#e86b47] hover:bg-[#d45a36] text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
        title="User Settings"
      >
